...
import { PreFetchFindRoomShelf, CreateRoomShelf, GetLastedRoomsShelf } from "../../shelves";

export class Store {
  private api = new RoomsApi({ basePath: "https://p01--api--sjtljr7v9y52.code.run" });

  public preFetchFindRoomShelf: PreFetchFindRoomShelf;
  ...
  constructor() {
    this.preFetchFindRoomShelf = new PreFetchFindRoomShelf(this.api);
